...
if df.empty:
    ...
    fig1 = px.pie(df, values="Volume (USD)", names="Symbol", title="Volume (USD) by Symbol")
    st.plotly_chart(fig1, use_container_width=True)

    # Pie Chart برای Bridges
    fig2 = px.pie(df, values="Bridges", names="Symbol", title="Bridges by Symbol")
